        ...
        <aside class="w-60 shrink-0 bg-gray-900 text-gray-300 flex flex-col">
            ...
            <nav class="flex-1 px-3 py-4 space-y-0.5 text-sm">
                ...
                <details class="space-y-0.5" {{ $isSettings ? 'open' : '' }}>
                    ...
                    <a href="/admin/settings/pages" class="block pl-9 pr-3 py-1.5 rounded-md hover:bg-gray-800 hover:text-white {{ request()->is('admin/settings/pages*') ? 'bg-gray-800 text-white' : '' }}">Pages</a>
                </details>
