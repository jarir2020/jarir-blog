    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-lg shadow-md p-8">
            ...
            <div class="mt-12 pt-8 border-t">
                <h2 class="text-xl font-bold text-gray-900 mb-6">Other Ways to Reach Us</h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm">contact@jarirblog.com</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        <svg class="w-6 h-6 text-blue-600 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm">123 Blog Street, Dhaka, Bangladesh</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        <svg class="w-6 h-6 text-blue-600 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm">+880 1234 567890</p>
                        </div>
                    </div>
                </div>
            </div>
